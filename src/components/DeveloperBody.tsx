...
function DeveloperBody({data}:Props){
    return(
        <>
        {
            data.map( (row : any, index: number) =>{
                return (
                <div key={index} className="flex flex-col md:flex-row border-solid border-2  border-[#444c56] py-20 ">
                    <div className="flex items-start w-15 md:w-30 justify-center">
                        <span>{index+1}</span>
                    </div>
                    <div className= "flex flex-row w-full">
                        <div className="flex items-start mr-16 md:w-1/3">
                            <img className="rounded-50 mx-16" src={row.avatar} width="48" height="48" alt="@asottile"/>
                        ...
                        <div className="flex flex-col md:w-1/3 px-20 ">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-[#539bf5] text-bold hover:underline hover:underline-offset-1">{row.reponame}</span>
                            </div>
